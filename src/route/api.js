...
import kelompokKegiatanKerjaController from "../controller/kelompok-kegiatan-kerja-controller.js";
import {authMiddleware} from "../middleware/auth-middleware.js";
import kelompokController from "../controller/kelompok-controller.js";
...
// Konfigurasi kelompok kegiatan kerja
userRouter.post('/api/konfigurasi', kelompokKegiatanKerjaController.create);

userRouter.post('/api/kelompok', kelompokController.create);
